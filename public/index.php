...
<html lang="en">
    ...
    <body>
        ...
        <!-- Stripe.js things -->
        <!--
            For this example, we exposed the PHP publishable key
            configuration variable as a global variable to be used in index.js.
            You need your publishable key when initializing Stripe.js, but the
            method of exposing a global variable is not necessarily recommended
            in a live application.
        -->
        <script>
            var publishableKey = <?php echo json_encode($config['stripe']['publishableKey']); ?>;
        </script>
